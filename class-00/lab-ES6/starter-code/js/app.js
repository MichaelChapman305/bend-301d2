...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The code threw an error because when we changed var rando to const rando it caused rando to be scoped local to the while loop block
  console.log(viewed);
